...
import com.example.quizappversionone.databinding.ActivityQuestionNineBinding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class QuestionNineActivity : AppCompatActivity() {

    lateinit var binding: ActivityQuestionNineBinding
    lateinit var viewModel: ViewModel
    private var team1: AnswerQ9? = null
    private var team2: AnswerQ9? = null


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuestionNineBinding.inflate(layoutInflater)
        ...
        viewModel.answersQ9.observe(this) { answers ->
    ...
    private fun checkAnswered(answers: List<AnswerQ9>) {
