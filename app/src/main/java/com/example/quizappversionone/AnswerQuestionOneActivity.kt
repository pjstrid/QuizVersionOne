...
import com.example.quizappversionone.databinding.ActivityAnswerQuestionOneBinding
import java.util.Locale.getDefault

class AnswerQuestionOneActivity : AppCompatActivity() {

    lateinit var binding: ActivityAnswerQuestionOneBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAnswerQuestionOneBinding.inflate(layoutInflater)
    ...
    private fun sendAnswers() {
        ...
        viewModel.updateAnswersQ1(currentUser, answerOne, answerTwo, answerThree, true)
    }
}