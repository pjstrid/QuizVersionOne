...
import com.example.quizappversionone.databinding.ActivityQuestionEightBinding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class QuestionEightActivity : AppCompatActivity() {

    lateinit var binding: ActivityQuestionEightBinding
    lateinit var viewModel: ViewModel
    private var team1: AnswerQ8? = null
    private var team2: AnswerQ8? = null


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuestionEightBinding.inflate(layoutInflater)
        ...
        viewModel.answersQ8.observe(this) { answers ->
    ...
    private fun checkAnswered(answers: List<AnswerQ8>) {
