...
import com.example.quizappversionone.databinding.ActivityAnswerQuestionNineBinding
import java.util.Locale.getDefault

class AnswerQuestionNineActivity : AppCompatActivity() {

    lateinit var binding: ActivityAnswerQuestionNineBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAnswerQuestionNineBinding.inflate(layoutInflater)
    ...
    private fun sendAnswers() {
        ...
        viewModel.updateAnswersQ9(currentUser, answerOne, answerTwo, true)
    }
}